...
Engine.prototype._configureApp = function() {
  ...
  const ipn = CoinPayments.ipn({
    'merchantId': process.env.CP_MERCHANT_ID,
    'merchantSecret': process.env.CP_PRIVATE_KEY
  });
