...
const DB_URL = process.env.DB_URL || ('mongodb://127.0.0.1:27017/__storj-bridge-' + process.env.NODE_ENV || 'development');
const DB_URL_OBJ = url.parse(DB_URL);
const DB_USER = DB_URL_OBJ.auth && DB_URL_OBJ.auth.split(':')[0];
const DB_PASS = DB_URL_OBJ.auth && DB_URL_OBJ.auth.split(':')[1];
...
Config.ENV_OVERRIDES = {
  storage: {
    ...
    pass: process.env.DB_PASS || DB_PASS,
