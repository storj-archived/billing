  ...
  addPaymentProcessor: function(name, data) {
    ...
    return this.models.PublicKey.findOne({_id: publicKeyHeader})
      .then((publicKey)=> {
        ...
        return new this.models.PaymentProcessor({
          user: user,
          name: name,
          ...
          .then((paymentProcessor) => {
            console.log('adding data to paymentprocessor');
            console.log(`data:\n${data}`);
            console.log(`paymentProcessor.data:\n${paymentProcessor.data}`);
            // paymentProcessor.data.customer = data;
            return paymentProcessor.adapter.register(data, user)
              .then((data) => {
      ...
      .catch(e => {
        console.error(`shit is broken!: ${e}`);
